                ...
                <div class="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
                    <div class="mb-4">
                        <div class="mb-6 max-w-3xl text-center sm:text-center md:mx-auto md:mb-12">
                            <p class="text-base font-bold uppercase tracking-wide text-blue-600">
                                Contact
                            </p>
                            <h2
                                class="font-heading mb-4 font-bold tracking-tight text-gray-900">
                                Get in Touch
                            </h2>
                            <p class="mx-auto mt-4 max-w-3xl text-xl text-gray-400">Hi, ask us any question you like
                            </p>
                        </div>
                    </div>
                    <div class="flex items-stretch justify-center">
                        <div class="grid md:grid-cols-2">
                            <div class="h-full pr-6">
                                <p class="mt-3 mb-12 text-lg text-gray-500 ">
                                    Welcome to Optimized Destination! We're here to make your travel experience effortless. Have any questions? Don't hesitate to reach out
                                    – our team is ready to assist you promptly. Let us handle the details so you can focus on enjoying your journey to the fullest
                                </p>
                                <ul class="mb-6 md:mb-0">
                                    <li class="flex">
                                        ...
                                        <div class="ml-4 mb-4">
                                            <h3 class="mb-2 text-lg font-medium leading-6 text-gray-700">Our Address
                                            </h3>
                                            <p class="text-gray-600">120 Hoang Minh Thao</p>
                                            <p class="text-gray-600">Da Nang, DTU</p>
                                        </div>
                                    </li>
                                    <li class="flex">
                                        <div class="flex h-10 w-10 items-center justify-center rounded bg-blue-900 text-gray-50">
                                        ...
                                        <div class="ml-4 mb-4">
                                            <h3 class="mb-2 text-lg font-medium leading-6 text-gray-700">Contact
                                            </h3>
                                            <p class="text-gray-600 dark:text-slate-400">Mobile: +84 (123) 998-889</p>
                                            <p class="text-gray-600 dark:text-slate-400">Mail: OptimizedDesTrip@gmail.com</p>
                                        </div>
                                    </li>
                                    <li class="flex">
                                        <div class="flex h-10 w-10 items-center justify-center rounded bg-blue-900 text-gray-50">
