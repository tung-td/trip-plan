        ...
        <div class="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
          <div class="mb-4">
            <div class="mb-6 max-w-3xl text-center sm:text-center md:mx-auto md:mb-12">
              ...
              <h2 class="font-heading mb-4 font-bold tracking-tight text-gray-900">
                Get in Touch
              </h2>
          ...
          <div class="flex items-stretch justify-center">
            <div class="grid md:grid-cols-2">
              <div class="h-full pr-6">
                <p class="mb-12 mt-3 text-lg text-gray-500 ">
                ...
                <ul class="mb-6 md:mb-0">
                  <li class="flex">
                    ...
                    <div class="mb-4 ml-4">
                      <h3 class="mb-2 text-lg font-medium leading-6 text-gray-700">
                        Our Address
                      </h3>
                    ...
                    <div class="mx-0 mb-1 sm:mb-4">
                      <div class="mx-0 mb-1 sm:mb-4">
                        ...
                        <input
                          ...
                          class="mb-2 w-full rounded-md border border-gray-400 py-2 pl-2 pr-4 text-gray-700 shadow-md"
                        />
                      </div>
                      <div class="mx-0 mb-1 sm:mb-4">
                        <label
