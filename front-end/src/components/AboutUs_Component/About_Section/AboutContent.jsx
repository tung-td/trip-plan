...
function AboutContent() {
    return (
        <section className={`max-w-7xl mx-auto py-10`}>
            ...
            >
                <TypingText title="| About Optimized Destination" textStyles="text-center" className="text-black" />
                ...
                <motion.p variants={fadeIn('up', 'tween', 0.2, 1)} className="mt-[8px] font-normal sm:text-[20px]  md:text-[20px] text-[12px] text-center text-black px-20">
                    <span className="font-normal  text-[#7a7a7a] ">
                        Optimized Destination is a popular travel platform that helps travelers plan their trips.
